# -*- coding: utf-8 -*-
#
# Ckan API NG documentation build configuration file, created by
...
htmlhelp_basename = 'CkanAPINGdoc'
...
latex_documents = [
  ('index', 'CkanAPING.tex', u'Ckan API NG Documentation',
...
man_pages = [
    ('index', 'ckanaping', u'Ckan API NG Documentation',
     [u'Samuele Santi'], 1)
]
...
texinfo_documents = [
  ('index', 'CkanAPING', u'Ckan API NG Documentation',
   u'Samuele Santi', 'CkanAPING', 'One line description of project.',
   'Miscellaneous'),
]
